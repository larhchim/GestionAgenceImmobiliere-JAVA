...
public class inserappartement extends JDialog{
	
	public inserappartement(JFrame g,String title,boolean a) {
		super(g,title,a);
		...
		JLabel nbretages=new JLabel("     numero d tages");
				...
				inserer.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						int nt=Integer.parseInt(nbrtoilettesselect.getText());
							...
							methodes.inserer_dans_appartement(pr,vi,su,ad,nc,ne,ncu,nb,nt);
							JOptionPane.showMessageDialog(null, "Votre Appartement est compté inséré avec succés","Message Informatif",JOptionPane.INFORMATION_MESSAGE);
