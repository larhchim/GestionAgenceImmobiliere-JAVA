...
public class insermodifvilla extends JDialog{
	int s;
	public insermodifvilla(JFrame g,String title,boolean a,int s) {
		super(g,title,a);
		this.s=s;
				...
				inserer.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						int nt=Integer.parseInt(nbrtoilettesselect.getText());
							...
							methodes.modifier_villa(s,pr,vi,su,ad,nc,ne,ncu,nb,nt);
							dispose();
							new modifvilla(null,"Boite De Modification Villa", true);
						} catch (Exception e) {
