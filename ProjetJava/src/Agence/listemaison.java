...
public class listemaison extends JDialog{
	
	public listemaison(JFrame g,String title,boolean a) throws Exception {
	    ...
	    this.setModal(false);
	    ArrayList<maison> tab1=new ArrayList<maison>();
	    tab1=methodes.liste_des_maisons();
