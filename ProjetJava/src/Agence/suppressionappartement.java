...
public class suppressionappartement extends JDialog{
	
	public suppressionappartement(JFrame a,String b , boolean c) throws Exception {
		 super(a,b,c);
			 ...
			 Object [][] data = new Object[tab.size()][10] ;
				  ...
				  tabRes.addMouseListener( new MouseListener() {
						...
						public void mouseClicked(MouseEvent evt) 
						{
					            ...
					            int conf = confirmation.showConfirmDialog(null, "voulez vous supprimer cette appartement ?","Confirmation de suppression",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
					         if(conf==JOptionPane.OK_OPTION) {
					        
					        	 try {
					        
					        		 	methodes.supprimer_appartement(s);
