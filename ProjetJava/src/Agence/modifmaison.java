...
public class modifmaison extends JDialog{
	
	public modifmaison(JFrame a,String b , boolean c) throws Exception {
		 super(a,b,c);
			 ...
			 Object [][] data = new Object[tab.size()][10] ;
				  ...
				  tabRes.addMouseListener( new MouseListener() {
						...
						public void mouseClicked(MouseEvent evt) 
						{
					            ...
					            int conf = confirmation.showConfirmDialog(null, "voulez vous Modifier cette maison ?","Confirmation de Modification",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
					         if(conf==JOptionPane.OK_OPTION) {
					        
					        	 try {
					        
						        		
                                new insermodifmaison(null,"Boite De Confirmation De Modification maison",true,s);
                                dispose();
