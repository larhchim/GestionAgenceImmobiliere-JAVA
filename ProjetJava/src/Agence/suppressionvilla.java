...
public class suppressionvilla extends JDialog{
	
	public suppressionvilla(JFrame a,String b , boolean c) throws Exception {
		 super(a,b,c);
			 ...
			 Object [][] data = new Object[tab.size()][10] ;
				  ...
				  tabRes.addMouseListener( new MouseListener() {
						...
						public void mouseClicked(MouseEvent evt) 
						{
					            ...
					            int conf = confirmation.showConfirmDialog(null, "voulez vous supprimer cette villa ?","Confirmation de Suppression",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
					         if(conf==JOptionPane.OK_OPTION) {
					        
					        	 try {
					        		 methodes.supprimer_villa(s);
