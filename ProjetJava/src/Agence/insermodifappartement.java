...
public class insermodifappartement extends JDialog{
	int s;
	public insermodifappartement(JFrame g,String title,boolean a,int s) {
		super(g,title,a);
		this.s=s;
		...
		JLabel nbretages=new JLabel("     numero d tage");
				...
				inserer.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						int nt=Integer.parseInt(nbrtoilettesselect.getText());
							...
							methodes.modifier_appartement(s,pr,vi,su,ad,nc,ne,ncu,nb,nt);
							dispose();
							new modifappartement(null,"Boide De Modification Appartement" , true);
						} catch (Exception e) {
