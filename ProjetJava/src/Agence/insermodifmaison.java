...
public class insermodifmaison extends JDialog{
	int s;
	public insermodifmaison(JFrame g,String title,boolean a,int s) {
		super(g,title,a);
		this.s=s;
				...
				inserer.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						int nt=Integer.parseInt(nbrtoilettesselect.getText());
							...
							methodes.modifier_maison(s,pr,vi,su,ad,nc,ne,ncu,nb,nt);
							dispose();
							new modifmaison(null,"Boite de Modification Maison" , true);
						} catch (Exception e) {
